...
def load_config():
    ...
    if not os.path.exists(CONFIG_FILE):
        ...
        return {
            ...
            'service_email_recovered': DEFAULT_CONFIG.get('service_email_recovered', '1') == '1',
    ...
    try:
        with open(CONFIG_FILE, 'r') as f:
            ...
            return {
                ...
                'service_email_recovered': config.get('service_email_recovered', DEFAULT_CONFIG.get('service_email_recovered', '1')) == '1',
